...
# ╔═╡ d7b68e9f-8924-4434-95cc-7e70e5426830
begin
	v1=[1;1;0];
	v2=[1;3;1];
	v3=[2;-1;1];
...
# ╔═╡ 0fad2be9-9a9c-4409-94a0-d0a5b36b3f38


# ╔═╡ 7cd547e1-e3d8-4a0d-8197-217bcc04aea4


# ╔═╡ 9ee2d078-8769-422b-b5f1-80761ff77fb3
begin
	f1=[1;3;3];
	f2=[1;3;0];
	f3=[0;0;3];
...
# ╔═╡ bb9ef0b8-eeab-4a03-be05-9baf073f4409
...
# ╔═╡ 0711e2bc-f6c0-4f62-9682-6789d46bc3ee
md"""
latitude = $(@bind l Slider(-90:1:90, show_value=true, default=30)) 
$nbsp $nbsp
longitude = $(@bind m Slider(-180:1:180, show_value=true, default=30))
"""

# ╔═╡ ed1435f3-9098-4b9c-9576-5f8edb95f5a5
begin
	plot3d([0,v1[1]],[0,v1[2]],[0,v1[3]],grid=false,arrow=3,linewidth=2,label=:"\$v_1\$",legendfontsize=12,xticks=false,yticks=false,zticks=false,camera = (m, l))
	plot3d!([0,v2[1]],[0,v2[2]],[0,v2[3]],arrow=3,linewidth=2,label="\$v_2\$")
	plot3d!([0,v3[1]],[0,v3[2]],[0,v3[3]],arrow=3,linewidth=2,label="\$v_3\$")
	plot3d!([0,w2[1]],[0,w2[2]],[0,w2[3]],arrow=3,linewidth=2,label="\$w_2\$")
	plot3d!([0,w3[1]],[0,w3[2]],[0,w3[3]],arrow=3,linewidth=2,label="\$w_3\$")
end

# ╔═╡ 13781d50-c95e-4f90-8bfe-b49d741e568d
md"""
latitude = $(@bind l1 Slider(-90:1:90, show_value=true, default=30)) 
$nbsp $nbsp
longitude = $(@bind m1 Slider(-180:1:180, show_value=true, default=30))
"""

# ╔═╡ b8d01a05-a78d-40f4-a38d-e404d6a7add3
begin
	plot3d([0,f1[1]],[0,f1[2]],[0,f1[3]],grid=false,arrow=3,linewidth=2,label=:"\$f\$",legendfontsize=12,xticks=false,yticks=false,zticks=false,camera = (m1, l1))
	plot3d!([0,f2[1]],[0,f2[2]],[0,f2[3]],arrow=3,linewidth=2,label="\$S_N(f)\$")
	plot3d!([f2[1],f2[1]],[f2[2],f2[2]],[f2[3],f3[3]],arrow=3,linewidth=2,label="\$f-S_N(f)\$")
end

# ╔═╡ d2cec051-e237-4c2a-baa2-56e5ce5d7f5f


# ╔═╡ 30a21f2a-cd27-43d1-9a37-794064f12172


# ╔═╡ d1db737a-73f4-458c-890b-63f9e6be58a8
