...
# ╔═╡ b60ebefe-f790-458b-a41a-f71473aee567
md""" 
### What is data? 

1. Matrices and vectors
2. Data expressed by matrices 
3. Data processing
...
We here consider real numbers which are arranged in some rows and columins and enclosed by brackets $[\cdot]$ or parentheses $(\cdot)$:

$\begin{bmatrix}1 & 2 & 3 \\ 4 & 5 & 6\end{bmatrix},
\quad
\begin{bmatrix}7 & 8 & 9\end{bmatrix}=[7,8,9],
\quad
\begin{bmatrix}10 \\ 11 \\ 12\end{bmatrix},$

$\begin{pmatrix}1 & 2 & 3 \\ 4 & 5 & 6\end{pmatrix},
\quad
\begin{pmatrix}7 & 8 & 9\end{pmatrix}=[7,8,9],
\quad
\begin{pmatrix}10 \\ 11 \\ 12\end{pmatrix}.$

We state the definition of matrrices and vectors. Denote the set of all the real numbers by $\mathbb{R}$. Let $m$ and $n$ be positive integers. Given $mn$ real numbers

$a_{ij} \in \mathbb{R}, \quad i=1,\dotsc,m, \quad j=1,\dotsc,n,$
...
\\
a_{21} & a_{22} & \dotsb & a_{2\ (n-1)} & a_{2n}
\\
\vdots & \vdots &        & \vdots & \vdots
\\
a_{(m-1)\ 1} & a_{(m-1)\ 2} & \dotsb & a_{(m-1)\ (n-1)} & a_{(m-1) n}
\\
a_{m1} & a_{m2} & \dotsb & a_{m\ (n-1)} & a_{mn}
\\
\end{bmatrix},$

which is said to be an $m{\times}n$ (real) matrix. The indices $i$ and $j$ of $a_{ij}$ means that $a_{ij}$ is located at the $i$-th row and the $j$-th columin, and $a_{ij}$ is said to be the $(i,j)$-element of the matrix $A$. The set of all the $m{\times}n$ real matrices are denoted by $\mathbb{R}^{m{\times}n}$. For example, 

$\begin{bmatrix}1 & 2 & 3 \\ 4 & 5 & 6\end{bmatrix}$

is a $2\times3$ matrix, and its $(1,2)$-element and $(2,3)$-element are $2$ and $6$ respectively.
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "9b47da0c5705f83a2fa30614dbff3babe5b444db"
