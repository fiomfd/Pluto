...
which is said to be the Haar wavelets. These are the typical example of the wavelets. This note shows the two-channel filter bank generated by this orthonormal system, which is the typical example of multiresolution analysis. 
...
The $N_0$-th root of $1$ is denoted by $\omega_{N_0}:=e^{2\pi{i}/N_0}$. The Fourier transform on $\mathbb{C}^{N_0}$ is defined by 
...
# ╔═╡ 5a583760-ed5c-4dd9-821c-faef70926fb0
anim1 = @animate for l=1:L+1
    p1=plot(colorview(RGB,Wapprox[:,:,:,l]),
        title="Approximation",
        xaxis=false, 
        xticks=false, 
        yaxis=false, 
        yticks=false, 
        grid=false);
    p2=plot(colorview(RGB,Wdetail[:,:,:,l]),
        title="Detail",
        xaxis=false, 
        xticks=false, 
        yaxis=false, 
...
# ╔═╡ 3381ff07-4237-48c8-953e-af6dd85a1212
gif(anim1, "animation_wavelet_char_kway_teow.gif", fps = 0.4)	
