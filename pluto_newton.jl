...
Define a sequance $\{x_n\}$ by 

$x_{n+1}:=x_n-\frac{f(x_n)}{f^\prime(x_n)}, \quad n=0,1,2,\dotsc$

so that $x_n \rightarrow c$ ($n \rightarrow \infty$) and $f(c)=0$.
...
# ╔═╡ 3c743ad1-c58f-4358-95ab-6a8bb851d93a
begin
nbsp = html"&nbsp"
end

# ╔═╡ 8b7193bf-cff2-4476-9ac1-1f6ff081fd0c
md"""
...
# ╔═╡ 1d24debe-6898-483e-b9c3-ecc0ede4f7c1
md"""
#### Example 2   $f(x)=x^3/5-4x+1$
"""

# ╔═╡ 30affe0b-b5e2-4fac-b79a-500e2b6ba47c
md"""
n = $(@bind n Slider(0:10, show_value=true, default=0))
$nbsp $nbsp
x₀ = $(@bind x0 Slider(-10:0.5:10, show_value=true, default=6))
"""

# ╔═╡ 38181bb5-d97a-47fe-8513-f6cfbf7bdf85


# ╔═╡ 7bd2ec5e-7532-4cca-912f-3da6acdd6783
md"""
#### Example 3   $f(x)=-x^3+3x$
"""

# ╔═╡ d969748a-10d5-4d61-97c9-5f8e9ac52681
md"""
n = $(@bind n3 Slider(0:10, show_value=true, default=0))
$nbsp $nbsp
x₀ = $(@bind x03 Slider(-2:0.1:2, show_value=true, default=6))
"""

# ╔═╡ 4699a0c5-47d8-425c-bc73-52495b366d49


# ╔═╡ 49027c98-8c18-456b-922a-adcc33eb034f
...
# ╔═╡ bb7d5554-f731-4fb8-9bd8-6d1093864891
...
let
	...
	standard_Newton(f, n2, -10:0.01:10, x02, -15, 70)
end

# ╔═╡ 0af86953-7034-473e-8ab1-e84e1def532d
let
	f(x) = x^3/5 - 4x + 1
	
	standard_Newton(f, n, -10:0.01:10, x0, -70, 70)
end

# ╔═╡ 94023f0c-61ab-48d9-9595-ee8b0ea0aaaf
let
	f(x) = -x^3+3*x
	
	standard_Newton(f, n3, -3:0.01:3, x03, -5, 5)
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "6ad4997fe37474c11961a07466d1a93f5906fa27"
